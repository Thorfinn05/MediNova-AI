          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-card rounded-lg p-6 h-full flex flex-col items-center text-center shadow-sm border border-border">
                ...
                <h3 className="font-semibold mb-3">Test Recommender</h3>
                <p className="text-muted-foreground text-sm">
                  Suggests relevant diagnostic tests based on symptoms and possible conditions.
                </p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-card rounded-lg p-6 h-full flex flex-col items-center text-center shadow-sm border border-border">
                ...
                <h3 className="font-semibold mb-3">Treatment Suggester</h3>
                <p className="text-muted-foreground text-sm">
                  Proposes evidence-based treatment options with Gemini 2.0 powered reasoning.
                </p>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-card rounded-lg p-6 h-full flex flex-col items-center text-center shadow-sm border border-border">
                ...
                <h3 className="font-semibold mb-3">Image Annotator</h3>
                <p className="text-muted-foreground text-sm">
                  Vision transformers analyze and annotate medical images for diagnostic assistance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl text-gradient">MediNova</span>
              </div>
